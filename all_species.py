...
def parse_args():
    ...
    parser.add_argument("--url-path", dest = 'url', type=str, default="all_species_table_url.txt",
...
if __name__ == "__main__":
    ...
    if not args.dry_run:
        filename = 'all_species.csv'
        data.to_csv(os.path.join(args.path, filename), encoding='utf-8', index=False)
